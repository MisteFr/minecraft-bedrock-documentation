...
<BinaryStream::writeString(gsl::basic_string_span<char const, -1>)>
```
```
...
## Read
<ReadOnlyBinaryStream::getUnsignedVarInt64()>
<ItemStack ReadOnlyBinaryStream::getType<ItemStack>()>
<ReadOnlyBinaryStream::getByte()>
<ReadOnlyBinaryStream::getByte()>
<ReadOnlyBinaryStream::getByte()>
<ItemStack ReadOnlyBinaryStream::getType<ItemStack>()@@Base>:
...
#    Base         Level Event Generic Packet
...
#    Base         Client Cache Status Packet
...
#    Base         Structure Template Data Request Packet
...
#    Base         Structure Template Data Response Packet
...
#    Base         Update Block Properties Packet
...
#    Base         Client Cache Blob Status Packet
...
#    Base         Client Cache Miss Response Packet
...
#    Base         Education Settings Packet
